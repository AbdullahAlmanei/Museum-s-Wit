...
//@input string                 api {"hint":"Enter your Hugging Face API token"}
...
const closeInteractable = sik.InteractionManager.getInteractableBySceneObject(script.closeBtn);
closeInteractable.onInteractorTriggerEnd(closeDialogue);
