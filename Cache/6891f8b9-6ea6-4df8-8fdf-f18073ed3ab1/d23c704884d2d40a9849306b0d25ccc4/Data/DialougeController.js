...
//@input float   padding          = 4.0
//@input int   charsPerLine = 35     // wrap width (monospace-equivalent chars)
//@input float lineHeight   = 6.0    // cm the frame must grow per extra line
//@input float baseHeight   = 30.0   // cm initial height (already set in Inspector)
...
function updateFrameHeight() {
    ...
    // size.y = Math.max( size.y + script.padding, minH);
