...
class SpeechToText extends BaseScriptComponent {
    ...
    onListenUpdate = async (eventData) => {
        if (eventData.isFinalTranscription) {
            ...
            if (script.loadingMaterial) { script.buttonMesh.addMaterial(script.idleMaterial); }
